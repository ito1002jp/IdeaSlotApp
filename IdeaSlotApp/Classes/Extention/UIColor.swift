...
extension UIColor{
    struct AppColor {
        private init() {}
        //common
        static let navigationbarColor = #colorLiteral(red: 0.4756349325, green: 0.4756467342, blue: 0.4756404161, alpha: 1)
        ...
        static let buttonColor = #colorLiteral(red: 0.8374180198, green: 0.8374378085, blue: 0.8374271393, alpha: 1)
